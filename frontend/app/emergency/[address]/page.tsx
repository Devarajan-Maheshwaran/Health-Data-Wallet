...
export default async function EmergencyCardPage({
  ...
  // Read from top-level column first, fall back to JSONB card
  ...
  const contacts: Array<{ name: string; phone: string; relationship: string }> =
    (Array.isArray(profile?.emergency_contacts) && (profile.emergency_contacts as any[]).length > 0
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10, fontFamily: 'monospace', color: 'rgba(252,165,165,0.45)', wordBreak: 'break-all' as const }}>
                {params.address}
              </div>
            </div>
          </div>
        ...
        {!hasAnyData && (
          <div style={{
            ...
            {profile?.phone && (
              ...
              }}>📞 Call Patient: {profile.phone}</a>
            )}
          </div>
        )}

        {/* Blood type + Allergies row — most critical first */}
          ...
          <div style={{
            ...
            {bloodGroup && (
              <div style={{
                ...
                <div style={{ fontSize: 36, fontWeight: 900, color: '#fff', letterSpacing: '-0.02em', lineHeight: 1 }}>
                  {bloodGroup}
                </div>
            ...
            {medFields.find(f => f.urgent) && (
              <div style={{
                ...
                <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(253,224,71,0.6)', textTransform: 'uppercase' as const, letterSpacing: '0.1em', marginBottom: 4 }}>Allergies</div>
