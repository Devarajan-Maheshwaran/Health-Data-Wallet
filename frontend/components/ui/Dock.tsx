...
function DockItem({ children, className = '', onClick, mouseX, spring, distance, magnification, baseItemSize }: { children: ReactNode, className?: string, onClick?: () => void, mouseX: MotionValue<number>, spring: any, distance: number, magnification: number, baseItemSize: number }) {
